...
- `scripts/poc_concurrency.py` and `scripts/poc_cache_hammer.py`: offline,
  no-network benchmarks (injected fake completion functions) that measure
  true batch concurrency and stress the DuckDB cache at 100 threads —
